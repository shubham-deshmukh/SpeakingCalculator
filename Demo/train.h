...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(492, 279);
			this->label1->TabIndex = 6;
			this->label1->Text = L"                                TO TRAIN\r\nSpeak The following words  each 30 times" 
				L" :\r\nDigits 0 -9 in the order\r\n\'plus\'\r\n\'minus\'\r\n\'into\'\r\n\'by\'\r\n  \r\n               " 
				L"                \r\n";
			this->label1->Click += gcnew System::EventHandler(this, &train::label1_Click);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(18, 355);
			...
			this->button2->Location = System::Drawing::Point(18, 447);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 char name[100]; // it will contain the name of the user (trainer) / label given on the user interface
			 trainingModule(name); // recording the user data

			 training(name); // forming the models
			 //record(name);
			 //printf("Test Line : %s", name);
